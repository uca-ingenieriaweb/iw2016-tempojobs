...
import es.uca.iw.tempojobs.domain.EmpresaIntegrationTest;
...
privileged aspect EmpresaIntegrationTest_Roo_IntegrationTest {
    
    declare @type: EmpresaIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: EmpresaIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: EmpresaIntegrationTest: @Transactional;
    
    @Autowired
    EmpresaDataOnDemand EmpresaIntegrationTest.dod;
    
    @Test
    public void EmpresaIntegrationTest.testCountEmpresas() {
    ...
    @Test
    public void EmpresaIntegrationTest.testFindEmpresa() {
    ...
    @Test
    public void EmpresaIntegrationTest.testFindAllEmpresas() {
        Assert.assertNotNull("Data on demand for 'Empresa' failed to initialize correctly", dod.getRandomEmpresa());
        long count = Empresa.countEmpresas();
    ...
    @Test
    public void EmpresaIntegrationTest.testFindEmpresaEntries() {
        Assert.assertNotNull("Data on demand for 'Empresa' failed to initialize correctly", dod.getRandomEmpresa());
        long count = Empresa.countEmpresas();
    ...
    @Test
    public void EmpresaIntegrationTest.testFlush() {
        Empresa obj = dod.getRandomEmpresa();
        Assert.assertNotNull("Data on demand for 'Empresa' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Empresa' failed to provide an identifier", id);
    ...
    @Test
    public void EmpresaIntegrationTest.testMergeUpdate() {
        Empresa obj = dod.getRandomEmpresa();
        Assert.assertNotNull("Data on demand for 'Empresa' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Empresa' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyEmpresa(obj);
        Integer currentVersion = obj.getVersion();
        Empresa merged = (Empresa)obj.merge();
        obj.flush();
    ...
    @Test
    public void EmpresaIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Empresa' failed to initialize correctly", dod.getRandomEmpresa());
    ...
    @Test
    public void EmpresaIntegrationTest.testRemove() {
        Empresa obj = dod.getRandomEmpresa();
        Assert.assertNotNull("Data on demand for 'Empresa' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Empresa' failed to provide an identifier", id);

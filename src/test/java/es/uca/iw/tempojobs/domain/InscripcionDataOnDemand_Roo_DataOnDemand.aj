...
privileged aspect InscripcionDataOnDemand_Roo_DataOnDemand {
    ...
    public Inscripcion InscripcionDataOnDemand.getNewTransientInscripcion(int index) {
        ...
        setFFechaInscripcion(obj, index);
        setSEstado(obj, index);
        return obj;
    }
    
    public void InscripcionDataOnDemand.setFFechaInscripcion(Inscripcion obj, int index) {
        Date fFechaInscripcion = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setFFechaInscripcion(fFechaInscripcion);
    }
    
    public void InscripcionDataOnDemand.setSEstado(Inscripcion obj, int index) {

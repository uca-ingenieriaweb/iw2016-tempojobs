...
import es.uca.iw.tempojobs.domain.PerfilIntegrationTest;
...
privileged aspect PerfilIntegrationTest_Roo_IntegrationTest {
    ...
    @Test
    public void PerfilIntegrationTest.testFindAllPerfils() {
        Assert.assertNotNull("Data on demand for 'Perfil' failed to initialize correctly", dod.getRandomPerfil());
        long count = Perfil.countPerfils();
        ...
        List<Perfil> result = Perfil.findAllPerfils();
    ...
    @Test
    public void PerfilIntegrationTest.testFindPerfilEntries() {
        Assert.assertNotNull("Data on demand for 'Perfil' failed to initialize correctly", dod.getRandomPerfil());
        long count = Perfil.countPerfils();
        if (count > 20) count = 20;
        int firstResult = 0;
        int maxResults = (int) count;
        List<Perfil> result = Perfil.findPerfilEntries(firstResult, maxResults);
    ...
    @Test
    public void PerfilIntegrationTest.testMergeUpdate() {
        Perfil obj = dod.getRandomPerfil();
        Assert.assertNotNull("Data on demand for 'Perfil' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Perfil' failed to provide an identifier", id);
    ...
    @Test
    public void PerfilIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Perfil' failed to initialize correctly", dod.getRandomPerfil());
    ...
    @Test
    public void PerfilIntegrationTest.testRemove() {
        Perfil obj = dod.getRandomPerfil();
        Assert.assertNotNull("Data on demand for 'Perfil' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Perfil' failed to provide an identifier", id);
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'Perfil' with identifier '" + id + "'", Perfil.findPerfil(id));
    }

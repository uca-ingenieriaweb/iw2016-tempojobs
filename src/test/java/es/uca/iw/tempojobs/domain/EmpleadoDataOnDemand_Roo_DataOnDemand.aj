...
privileged aspect EmpleadoDataOnDemand_Roo_DataOnDemand {
    ...
    public void EmpleadoDataOnDemand.setUsuarioEmpleado(Empleado obj, int index) {
        Empleado UsuarioEmpleado = obj;
        obj.setUsuarioEmpleado(UsuarioEmpleado);
    }

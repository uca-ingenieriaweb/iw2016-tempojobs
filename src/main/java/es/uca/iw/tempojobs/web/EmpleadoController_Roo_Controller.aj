...
privileged aspect EmpleadoController_Roo_Controller {
    ...
    void EmpleadoController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("empleado_fechanac_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("empleado_fechainicio_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("empleado_fechafinal_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }

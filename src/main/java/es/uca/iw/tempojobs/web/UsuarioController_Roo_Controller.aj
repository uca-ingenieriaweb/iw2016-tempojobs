...
import es.uca.iw.tempojobs.web.UsuarioController;
...
privileged aspect UsuarioController_Roo_Controller {
    ...
    void UsuarioController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("usuario_ffechanac_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
    ...
    void UsuarioController.populateEditForm(Model uiModel, Usuario usuario) {
        ...
        uiModel.addAttribute("etipoes", Arrays.asList(ETipo.values()));
    }

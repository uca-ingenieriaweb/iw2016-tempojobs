...
privileged aspect AdminController_Roo_Controller {
    ...
    public String AdminController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, Admin.findAdmin(id));
        return "admins/update";
    }
    ...
    void AdminController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("admin_fechanac_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }

...
privileged aspect FormacionController_Roo_Controller {
    ...
    void FormacionController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("formacion_ffechainicio_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("formacion_ffechafinal_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
